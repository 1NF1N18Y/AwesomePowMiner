...
void EthStratumClient::connect_handler(const boost::system::error_code& ec)
{
        ...
        if (hec)
        {
            ...
            {  // certificate verification failed
                ...
                cwarn << "* Disable certificate verification all-together via environment "
                         "variable. See awesomepowminer --help for info about environment variables";
    ...
    */
    ...
    case EthStratumClient::STRATUM:
        ...
        jReq["jsonrpc"] = "2.0";
        jReq["params"].append(std::string(awesomepowminer_get_buildinfo()->project_name) + "/" +
                              std::string(awesomepowminer_get_buildinfo()->project_version));
    ...
    case EthStratumClient::ETHEREUMSTRATUM:
        ...
        jReq["params"].append(awesomepowminer_get_buildinfo()->project_name_with_version);
    ...
    case EthStratumClient::ETHEREUMSTRATUM2:
        ...
        Json::Value jPrm;
        jPrm["agent"] = awesomepowminer_get_buildinfo()->project_name_with_version;
...
void EthStratumClient::processResponse(Json::Value& responseObject)
{
        ...
        (_isNotification && (responseObject["params"].empty() && responseObject["result"].empty())))
    {
        ...
        cwarn << "Do not blame awesomepowminer for this. Ask pool devs to honor http://www.jsonrpc.org/ "
                 "specifications ";
        cwarn << "Disconnecting...";
        m_io_service.post(m_io_strand.wrap(boost::bind(&EthStratumClient::disconnect, this)));
        return;
    ...
    */
    ...
    if (_isNotification && m_conn->StratumModeConfirmed())
    {
        ...
        {
            jReq["id"] = _id;
            jReq["result"] = awesomepowminer_get_buildinfo()->project_name_with_version;
