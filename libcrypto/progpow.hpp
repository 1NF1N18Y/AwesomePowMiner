...
constexpr static uint32_t kRegs{6};                // uint32 registers per lane
...
constexpr static uint32_t kCache_count{4};         // random cache accesses per loop
constexpr static uint32_t kMath_count{6};          // random math instructions per loop
