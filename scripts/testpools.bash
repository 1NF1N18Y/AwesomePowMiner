...
#
# Testscript to test awesomepowminer multiple pools/hosts/syntaxes
# Put this script in the bin directory of awesomepowminer and start running
#
...
# export some vars as "./awesomepowminer" could be still a wrapper script
...
for pool in $POOLS; do
    ...
    echo "./awesomepowminer -v 1 --exit --report-hashrate -P $pool $@"
    echo "./awesomepowminer -v 1 --exit --report-hashrate -P $pool $@" > log.txt
    ./awesomepowminer -v 1 --exit --report-hashrate -P $pool $@ >> log.txt 2>&1 &
    pid=$!
    #echo "PID=$pid"
